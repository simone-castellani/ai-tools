...
2) Decide commit boundaries (split if needed)
   ...
   - If changes are mixed in one file, split the file changes first or stage explicit paths only. Avoid interactive staging in non-interactive environments.
...
6) Write the commit message
   ...
   - Prefer a direct multi-line message when working non-interactively
